...
user's preference, which may be designated by setting a `format` key in the configuration file. Supported formats are:

- `CSRS`: .pos file generated by the [CSRS-PPP](https://webapp.csrs-scrs.nrcan-rncan.gc.ca/geod/tools-outils/ppp.php?locale=en) online tool offered by the Canadian Geodetic Survey
