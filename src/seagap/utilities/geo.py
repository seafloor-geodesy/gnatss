...
LLA_PROJ = pyproj.Proj(proj='longlat', ellps='WGS84') # Longitude Latitude (lon, lat, alt)
...
def geodetic2geocentric(lon: float, lat: float, alt: float) -> Tuple[float, float, float]:
    """
...
def geodetic2enu(lon: float, lat: float, alt: float, lon_org: float, lat_org: float, alt_org: float) -> Tuple[float, float, float]:
    """
...
def enu2geodetic(east: float, north: float, up: float, lon_org: float, lat_org: float, alt_org: float) -> Tuple[float, float, float]:
    """
