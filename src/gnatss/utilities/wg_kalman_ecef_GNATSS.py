...
def main():
    ...
    vel_df = pd.read_csv(
        "/Volumes/SeaJade 2 Backup/ONC/Data/John_GNSSA/2018/NCL1_2018/NCL1/261/WG_20180918/INS_VEL",
        header=None,
        sep="\s+",
        names=["dts", "dtype", "lat", "lon", "hae", "vel_n", "vel_e", "vel_u"],
        low_memory=False,
    )

    vel_std = pd.read_csv(
        "/Volumes/SeaJade 2 Backup/ONC/Data/John_GNSSA/2018/NCL1_2018/NCL1/261/WG_20180918/COV_VEL",
        header=None,
        sep="\s+",
        names=[
            "dts",
    ...
    pos_df = pd.read_csv(
        "/Volumes/SeaJade 2 Backup/ONC/Data/John_GNSSA/2018/NCL1_2018/NCL1/261/GPS_PPP/GPS_POS_FREED",
        header=None,
        names=["dts", "dtype", "x", "y", "z", "sdx", "sdy", "sdz"],
        sep="\s+",
        low_memory=False,
    )
